...
public class DetailActivity extends AppCompatActivity {
    ...
    private TextView dateTextView, sleepTextView, typeExerciseTextView,
            timeExerciseTextView, drinkWaterTextView, weightTextView;
    ...
    private void showTextView() {
        ...
        timeExerciseTextView.setText("TimeExercise = " + strTimeExercise + " ชัวโมง");

        String strDrinkWater = getIntent().getStringExtra("DrinkWater");
        drinkWaterTextView.setText("DrinkWater = " + strDrinkWater + " แก้ว");
    ...
    private void bindWidget() {
        ...
        drinkWaterTextView = (TextView) findViewById(R.id.txtDrinkWater);
